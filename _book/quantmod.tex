...
\hypersetup{
            pdftitle={quantmod：从数据获取到策略实战全景指南},
            pdfauthor={邓一硕},
            colorlinks=true,
            linkcolor=Maroon,
            citecolor=Blue,
...
\includegraphics[width=0.9\linewidth]{quantmod_files/figure-latex/kdj_2-1}
...
\includegraphics[width=0.9\linewidth]{quantmod_files/figure-latex/defi-2}
...
\includegraphics[width=0.9\linewidth]{quantmod_files/figure-latex/defi-3}
